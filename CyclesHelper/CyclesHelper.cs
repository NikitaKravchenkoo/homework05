...
namespace CyclesHelper
{
    public class CyclesHelper
    {
        ...
        public static int GetElementOfFibbo(int number)
        {
            if (number <= 0)
            {
        ...
        public static int GetGreatestDivisior(int a, int b)
        {
            while ((a != 0) && (b != 0))
            {
                if (a > b)
        ...
        public static double GetNumberNWithBinaryAlgorithm(double a)
        {
